...
\begin{document}
  \begin{tikzpicture}[scale=0.47]
	...
	\node (mode) at (16,14.5) {\scriptsize TCP options (variable length, optional)};
    \end{tikzpicture}
  \end{document}
